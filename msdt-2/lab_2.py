...
def getsitesdenied(dico):
    print
    "\033[1;34m", "+" + "=" * 101 + "+", "\033[0m"
    print
    "\033[1;34m | time", "\t\t\t Kbytes\t\t   ip address",
    print
    "\t    web site\t ", "\t\t", "       |\033[0m"
    print
    "\033[1;34m", "+" + "=" * 101 + "+", "\033[0m"
    for key, value in dico.items():
        ...
        if str(site) == "TCP_DENIED":
            ...
            print
            "\033[1;34m |\033[0m\033[1;37m %-15s\t\033[1;34m|\033[0m%-10s\033[1;34m\
...
def getsites(dico, ip):
    i = 0
    print
    "\033[1;34m", "+" + "=" * 102 + "+", "\033[0m"
    print
    "\033[1;34m | time", "\t\t\t Kbytes\t\t   method",
    print
    "\t    web site\t ", "\t\t", "        |\033[0m"
    print
    "\033[1;34m", "+" + "=" * 102 + "+", "\033[0m"
...
def ipbandwidth(dico, m):
    ...
    if d != {}:
        ...
        for i in d:
            print
            "\033[1;34m |\033[0m\033[1;37m %-15s\t\t\033[1;33m%-12s\033[1;34m |\033[0m" % (str(i[0]), str(i[1]))
        print
        "\033[1;34m", "+" + "=" * 43 + "+""\033[0m"
    else:
        print
        "\033[1;34m | No Data ", "\t" * 9, "|\033[0m"
...
def sitebandwidth(dico, m):
    ...
    if d != {}:
        ...
        for i in d:
            print
            "\033[1;34m |\033[0m\033[1;37m %-35s\t\t\033[1;33m%-12s\033[1;34m |\033[0m" % (str(i[0]), str(i[1]))
        print
        "\033[1;34m", "+" + "=" * 59 + "+""\033[0m"
    else:
        print
...
def main():
    ...
    if start:
        ...
        "\n"
        print
        "file: \033[1;34m", logfile, "\033[0m"
        print
        "size: \033[1;34m", str(os.stat(logfile).st_size), " Bytes", "\033[0m"
        print
        "elapsed time: \033[1;34m%0.3f" % float(totaltime) + "s\033[0m\n"
    else:
        usage()
        return
