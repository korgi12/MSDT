...
app.layout = html.Div([
    ...
    dcc.Tabs(id="tabs", children=[
        dcc.Tab(label="Some Basic Information", children=[
            html.Div([
                html.P("This project is made just for educational purpose. "
                       ...
                       "Model are entirely probablistic based.",
                       style={"textAlign": "center"}),
                ...
                html.Ol(children=[
                    ...
                    html.Li("First Plot is the plot obtained "
                            "from testing the model again past data"),
                    html.Li("Second Plot is the plot that contains "
                            "the future predictions made by the model")
                ]
                ),
        ...
        dcc.Tab(label="See the model in Action", children=[
            ...
            html.H1("Future Price Prediction",
                    style={
                        "textAlign": "center",
                        "margin": "0px"
                    }),
...
def update_graph(value):
    ...
    try:
        ...
        close_data, forecast, forecast_dates = predicting(close_data, lstm_model,
                                                          15, df)
        figure_2 = plot_future_prediction(lstm_model, test_generator,
                                          close_train, close_test,
                                          df, forecast_dates, forecast)
        r2_score_s = "R2 Score : {}".format(r2_score_s)
        return figure_1, figure_2, r2_score_s, info.info["longBusinessSummary"]
    except:
        empty = return_empty_graph()
        return empty, empty, "No R2 Score to display", "No Asset Queried or Selected"
